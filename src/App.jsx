  ...
  const postsMockContent = [
    {
      ...
      content: '<p>Hey folks 👋</p><br/><p>Just updated my portfolio. This is a project I worked on during NLW Return, an event by Rocketseat. Check out DoctorCare down below.</p><br/><p>👉 <a href="#">jane.design/doctorcare</a></p><br/><p><span>#newProject #nlw #rocketseat</span></p>'
    },
    {
      ...
      content: [
        'Finally, the first version of my portfolio is out! 🙌 It was challenging to design and code the whole thing, but it turns out great. Check it out here -> ',
        'bessie.dev',
        '#portfolio #frontend #fullStack #design'
      ]
    }
  ];
